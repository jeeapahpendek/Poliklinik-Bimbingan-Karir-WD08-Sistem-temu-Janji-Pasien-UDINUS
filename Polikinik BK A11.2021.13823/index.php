...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-expand-lg navbar-light bg-light pt-2 ps-4 pe-3 shadow-sm fixed-top">
        <div class="container">
            <a class="navbar-brand" href="index.php">Poliklinik Anime </a>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="text">
                                                    ...
                                                    <h2>Pasien - Dokter</h2>
                                                    <p>Selamat datang di Poliklinik Senku , pusat perawatan kesehatan yang berkomitmen menyediakan perhatian 
